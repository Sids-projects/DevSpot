import { L as E, N as gt, a as ue, c as pt } from "./browser/chunk-XK67K6PH.js";
var _ = (function (n) {
    return (
      (n[(n.State = 0)] = "State"),
...
var Y = null,
  Et = !1;
function Cs(n) {
  Y || ((Y = ks() || {}), (Et = Y.style ? "WebkitAppearance" in Y.style : !1));
  let e = !0;
  return (
    Y.style &&
      !Ms(n) &&
...
function Os(n, e, t) {
  ...
  if (typeof n == "string") {
    let a = n.match(s);
    if (a === null) return e.push(_t(n)), { duration: 0, delay: 0, easing: "" };
...
function X(n) {
  return (
    n ? ((n = ue({}, n)), n.params && (n.params = Ws(n.params))) : (n = {}), n
  );
}
function ke(n, e, t) {
...
var Ue = class {
    ...
    _applyAnimationRefDelays(e, t, s) {
      for (let i of e) {
        ...
        if (r) {
          let o =
            typeof r == "number" ? r : $(oe(r, i?.params ?? {}, t.errors));
          s.delayNextStep(o);
        }
      }
    }
    ...
    visitSequence(e, t) {
      ...
      if (
        ...
        i.previousNode.type == _.Style &&
          (i.currentTimeline.snapshotCurrentStyles(), (i.previousNode = ve));
        let o = $(r.delay);
        i.delayNextStep(o);
      }
      e.steps.length &&
      ...
      if (r) {
        ...
        o || (o = this.options.params = {}),
          Object.keys(r).forEach((a) => {
            (!t || !o.hasOwnProperty(a)) && (o[a] = oe(r[a], o, this.errors));
          });
      }
    }
    _copyOptions() {
  ...
  we = class {
    ...
    build(e, t, s, i, r, o, a, l, h, c) {
      ...
      return (
        ...
        u.length
          ? Nt(t, this._triggerName, s, i, N, d, T, [], [], P, M, C, u)
          : (q.forEach((k) => {
              let W = k.element,
                J = O(P, W, new Set());
              k.preStyleProps.forEach((G) => J.add(G));
              let ct = O(M, W, new Set());
              k.postStyleProps.forEach((G) => ct.add(G)), W !== t && b.add(W);
            }),
            Nt(
              t,
              this._triggerName,
...
var ni = new se(),
          ...
          o &&
            o.forEach((a) => {
              if (a.name == s.triggerName) {
                ...
                (l._data = e), tt(s.player, a.phase, l, a.callback);
              }
            }),
            i.markedForDestroy
              ? this._engine.afterFlush(() => {
  ...
  xe = class {
    ...
    listen(e, t, s, i, r) {
      return pe(t) ? this._fetchNamespace(e).listen(t, s, i, r) : () => {};
    }
        ...
        this._namespaceList[f].drainQueuedTransitions(t).forEach((p) => {
            ...
            if (D && D.setForMove) {
              if (
                ...
                if (L && L.has(p.triggerName)) {
                  ...
                  (he.value = H), L.set(p.triggerName, he);
                }
              }
              v.destroy();
              return;
          ...
          o.push(Gt),
            ...
            w.postStyleProps.forEach((D, H) => {
              let L = h.get(H);
              L || h.set(H, (L = new Set())), D.forEach((he, De) => L.add(De));
            });
        });
      if (q.length) {
        let f = [];
    ...
    _buildAnimation(e, t, s, i, r, o) {
      let a = t.triggerName,
        ...
        S = t.timelines.map((d) => {
          ...
          let b = g !== l,
            P = pi((s.get(g) || hi).map((C) => C.getRealPlayer())).filter(
              (C) => {
                let k = C;
    ...
    beforeDestroy() {
      ...
      this.hasStarted() &&
        this._finalKeyframe.forEach((s, i) => {
          i !== "offset" && e.set(i, this._finished ? s : ot(this.element, i));
        }),
...
var Ot = class {
    ...
    buildTimelines(e, t, s, i, r) {
      let o = Array.isArray(t) ? wt(t) : t,
        ...
        l = [];
      r = r || new se();
      let h = ht(this._driver, e, this._animationAst, nt, ye, o, a, i, r, l);
